(() => {
  ...
  function copy(es){
    return es ? {
      ...
      note:'La activación no es instantánea ni automática. Los aportes desde US$1 siguen recibiendo certificado permanente; PRO se solicita desde US$10.'
    } : {
      nav:'PRO License',
      badge:'PRO LICENSE',
      ...
      note:'Activation is not instant or automatic. Contributions from US$1 still receive the permanent supporter certificate; PRO may be requested from US$10.'
    };
  }
